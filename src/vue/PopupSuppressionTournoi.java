...
import controleur.ControleurPopupSuppressionTournoi;
import modele.Tournoi;
import ressources.CharteGraphique;

public class PopupSuppressionTournoi extends JDialog {
	...
	private ControleurPopupSuppressionTournoi controleur;

	public PopupSuppressionTournoi(Tournoi tournoi, VueMain vue) {
		this.controleur = new ControleurPopupSuppressionTournoi(this, vue, tournoi);
	...
	private void setTextArea() {
		...
		textAreaMessage.setText("Voulez-vous supprimer le tournoi " + this.nomTournoi + " ?");
	}
