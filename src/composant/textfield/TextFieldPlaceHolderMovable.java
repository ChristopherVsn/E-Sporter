...
/**
 * Un textField avec PlaceHolder se déplaçant vers le haut.
 * 
 * @author Vivien
 *
 */
public class TextFieldPlaceHolderMovable extends JTextField {
	 ...
	 *         <code>TextFieldPlaceHolderMovable</code>
	 */
	...
	/**
	 * Défini le texte en placeholder qui se déplace
	 * 
	 * @param labelText le texte d'indication en placeholder.
	 */
	...
	/**
	 * Crée un nouveau <code>TextFieldPlaceHolderMovable</code>
	 */
	public TextFieldPlaceHolderMovable() {
		...
		addFocusListener(new FocusAdapter() {
			...
			public void focusGained(FocusEvent fe) {
				...
				TextFieldPlaceHolderMovable.this
						.setBorder(new RoundedCornerBorderTightPlain(TextFieldPlaceHolderMovable.this.border));
			}
